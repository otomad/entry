...
//    te_font.setLetterSpacing(QFont::AbsoluteSpacing, 0);             //设置字间距为3像素 //设置字间距像素值
	...
	m_leftPixmap = QPixmap(":/chatmessage/img/customer.png");
	m_rightPixmap = QPixmap(":/chatmessage/img/service.png");

    m_loadingMovie = new QMovie(this);
	m_loadingMovie->setFileName(":/chatmessage/img/loading.gif");
...
void QNChatMessage::setText(QString text) {
	m_msg = text;
	this->update();
}
